...
let terms = [

	{
		...
		text: `
			...
			This Software functions as a free, open source digital wallet. The Software does not constitute an account where We or other third parties serve as financial intermediaries or custodians of Your funds.
			While the Software has undergone beta testing and continues to be improved by feedback from the open-source user and developer community, We cannot guarantee there will not be bugs in the Software. You acknowledge that Your use of this Software is at Your own discretion and in compliance with all applicable laws. You are responsible for safekeeping Your passwords, private keys, backup phares and any other codes You use to access the Software.
			IF YOU LOSE ACCESS TO YOUR TRUSTY WALLET OR YOUR ENCRYPTED PRIVATE KEYS AND YOU HAVE NOT SEPARATELY STORED A BACKUP OF YOUR WALLET OR BACKUP PHRASE AND CORRESPONDING PASSWORD, YOU ACKNOWLEDGE AND AGREE THAT ANY FUNDS YOU HAVE ASSOCIATED WITH THAT WALLET WILL BECOME INACCESSIBLE. All transaction requests are irreversible. The authors of the Software, employees and affiliates of Trusty, copyright holders, and Trusty software cannot retrieve Your private keys or passwords if You lose or forget them and cannot guarantee transaction confirmation as they do not have control over the BitShares blockchain network.
...
Trading and investing in digital assets is highly speculative and comes with many risks. The analysis / stats / strategies on Trusty.Fund are not investment advice and shall be used with caution and at your own discretion. Statements on Trusty.Fund should not be construed as an endorsement or recommendation to buy, sell or hold. Please do your own research on all of your investments carefully.
...
This Agreement, and its application and interpretation, shall be governed exclusively by the laws of the BitShares blockchain code and respective jurisdictions.
